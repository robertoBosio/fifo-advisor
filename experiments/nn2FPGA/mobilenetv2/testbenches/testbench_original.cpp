...
extern void mobilenet_v2(hls::stream<ap_axiu<128, 0, 0, 0>>& global_in, hls::stream<ap_axiu<128, 0, 0, 0>>& global_in_1, hls::stream<ap_axiu<128, 0, 0, 0>>& global_out);
int main(int argc, char** argv)
{
    ...
    mobilenet_v2(global_in, global_in_1, global_out);
    hls_stream_to_txt<ap_axiu<128, 0, 0, 0>, ap_int<8>, char>(file_global_out, global_out, 16, {1, 1000});
