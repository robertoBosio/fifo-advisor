...
set proj_name   "yolov10n_${type}_HLS_project"
...
csim_design -argv "data/global_in.txt data/global_in_1.txt data/global_out.txt data/global_out_1.txt data/global_out_2.txt"
csynth_design
cosim_design -argv "data/global_in.txt data/global_in_1.txt data/global_out.txt data/global_out_1.txt data/global_out_2.txt"
