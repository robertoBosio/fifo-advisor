...
void resnet8(hls::stream<ap_axiu<128, 0, 0, 0>>& global_in, hls::stream<ap_axiu<128, 0, 0, 0>>& global_in_1, hls::stream<ap_axiu<128, 0, 0, 0>>& global_out)
{
    ...
    #pragma HLS STREAM variable=BandwidthAdjustDecreaseChannels_0_out0_stream[0] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_0_out0_stream[1] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_0_out0_stream_prepad[2] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_0_out0_stream_prepad[8] depth=128
    #pragma HLS STREAM variable=StreamingLineBuffer_0_out0_stream_prepad[9] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_0_out0_stream_prepad[14] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_0_buffer_stream[13] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_1_out0_stream[3] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_1_out0_stream_prepad[9] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_1_out0_stream_prepad[15] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_1_buffer_stream[10] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_2_out0_stream_prepad[8] depth=32
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_2_out0_stream_prepad[13] depth=32
    #pragma HLS STREAM variable=StreamingLineBuffer_2_out0_stream_prepad[14] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_2_out0_stream_prepad[15] depth=32
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_2_buffer_stream[11] depth=32
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_3_out0_stream[4] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_3_out0_stream[15] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_3_out0_stream[21] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_3_out0_stream[22] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_3_out0_stream[23] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_3_out0_stream[26] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_3_buffer_stream[14] depth=128
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_5_out0_stream[9] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_5_out0_stream[12] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_5_out0_stream[15] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_5_out0_stream_prepad[2] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_5_out0_stream_prepad[3] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_5_out0_stream_prepad[4] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_5_out0_stream_prepad[12] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_5_buffer_stream[3] depth=64
    ...
    #pragma HLS STREAM variable=StreamingAdd_1_out0_stream[2] depth=64
    ...
    #pragma HLS STREAM variable=TensorDuplicator_2_out0_stream[0] depth=64
    ...
    #pragma HLS STREAM variable=TensorDuplicator_2_out1_stream[0] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream[8] depth=64
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream[9] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream[13] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream[19] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[1] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[2] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[5] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[12] depth=64
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[13] depth=64
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[14] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[15] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[16] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[17] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[18] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[19] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[20] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[21] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_6_out0_stream_prepad[22] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_6_buffer_stream[3] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_6_buffer_stream[15] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_6_buffer_stream[20] depth=64
    #pragma HLS STREAM variable=StreamingLineBuffer_6_buffer_stream[21] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_7_out0_stream[4] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_7_buffer_stream[0] depth=64
    #pragma HLS STREAM variable=StreamingLineBuffer_7_buffer_stream[1] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_7_buffer_stream[2] depth=64
    ...
    #pragma HLS STREAM variable=StreamingConv_6_out0_stream[1] depth=64
    #pragma HLS STREAM variable=StreamingConv_6_out0_stream[2] depth=2
    #pragma HLS STREAM variable=StreamingConv_6_out0_stream[3] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream[3] depth=64
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream[4] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream[5] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream[12] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream[17] depth=2
    hls::stream<std::array<ap_uint<8>, 2>> StreamingLineBuffer_8_out0_stream_prepad[18];
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream_prepad[0] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream_prepad[6] depth=64
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream_prepad[7] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream_prepad[8] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream_prepad[12] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream_prepad[13] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream_prepad[14] depth=2
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream_prepad[15] depth=64
    #pragma HLS STREAM variable=StreamingLineBuffer_8_out0_stream_prepad[16] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_8_buffer_stream[3] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_8_buffer_stream[8] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_8_buffer_stream[11] depth=64
    ...
    #pragma HLS STREAM variable=StreamingConv_8_out0_stream[2] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_9_out0_stream[61] depth=2
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_9_buffer_stream[4] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_9_buffer_stream[17] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_9_buffer_stream[22] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_9_buffer_stream[25] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_9_buffer_stream[34] depth=64
    #pragma HLS STREAM variable=StreamingLineBuffer_9_buffer_stream[35] depth=64
    ...
    #pragma HLS STREAM variable=StreamingLineBuffer_9_buffer_stream[46] depth=64
