...
template <typename TInputWindow, typename TInputWord, typename TInput,
          typename TOutputWord, typename TOutput, typename Quantizer,
          typename TAcc, typename TDiv, size_t OUT_CH, size_t OUT_HEIGHT,
          size_t OUT_WIDTH, size_t FH, size_t FW, size_t STRIDE_H,
          size_t STRIDE_W, size_t CH_PAR, size_t W_PAR>
